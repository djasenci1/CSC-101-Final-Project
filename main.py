class Person:
    ...
    def __init__(self, name, phone, laptop, ipad, airpods, total_phone_charging_time, total_laptop_charging_time, total_ipad_charging_time, total_airpods_charging_time, total_phone_charging_frequency, total_laptop_charging_frequency, total_ipad_charging_frequency, total_airpods_charging_frequency):
        name: dict[str, float]
