...
def phone_charging_time(dict_phone: dict[str, float]) -> list[float]:
    ...
    if new1 < main.Person[phone_charging_time]: #This is the five row on the Person Object calling the total_phone_charging_time in the test_file
        total = main.Person[phone_charging_time]
