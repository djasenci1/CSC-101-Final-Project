...
class TestCases(unittest.TestCase):
    def test_person_phone_lowest_wattage(self):
        result = function.person_phone_lowest_wattage(surveyed_data, 11)
        expected = [{"Diana": 19}, 10.78, {"Fiona": 17}, 7.1]
        self.assertEqual(result, expected)

    def test_person_phone_highest_wattage(self):
        result = function.person_phone_highest_wattage(surveyed_data, 11)
        expected = [
            {"Adam": 18},
            13.6,
            {"Jack": 17},
    ...
    def test_person_laptop_lowest_wattage(self):
        result = function.person_laptop_lowest_wattage(surveyed_data, 11)
        expected = [{"Fiona": 17}, 0]
        self.assertEqual(result, expected)

    def test_person_laptop_highest_wattage(self):
        result = function.person_laptop_highest_wattage(surveyed_data, 200)
        expected = [
            {"Adam": 18},
            300,
            {"Ramses": 18},
    ...
    def test_person_ipad_lowest_wattage(self):
        result = function.person_ipad_lowest_wattage(surveyed_data, 20)
        expected = [
            {"Adam": 18},
            0,
            {"Jack": 17},
    ...
    def test_person_ipad_highest_wattage(self):
        result = function.person_ipad_highest_wattage(surveyed_data, 30)
        expected = [
            {"Ramses": 18},
            31.29,
            {"Bella": 19},
    ...
    def test_person_airpods_lowest_wattage(self):
        result = function.person_airpods_lowest_wattage(surveyed_data, 0.09)
        expected = [
            {"Adam": 18},
            0,
            {"Ramses": 18},
    ...
    def test_person_airpods_highest_wattage(self):
        result = function.person_airpods_highest_wattage(surveyed_data, 1)
    ...
    def test_total_cost_in_a_year(self):
        result = function.total_costs_in_a_year(
            all_wattage(total_wattage_used(surveyed_data))
        )
        expected = 2156
        self.assertEqual(expected, result)
